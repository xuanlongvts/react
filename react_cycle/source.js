    ...
    render() {
        return (
            <div>
                ...
                <p>
                    <span>Pass: </span>
                    <input type="checkbox" defaultChecked={this.state.isPassed} disabled={true} />
                </p>
            </div>
        );
    }
    ...
    render() {
        return (
            <div>
                <h4>Score Board</h4>
                <div>
                    <button onClick={amount => this.changeScore(5)}>Score of Nong: +5</button>{' '}
                    <button onClick={amount => this.changeScore(-5)}>Score of Tiki: -5</button>
                </div>
